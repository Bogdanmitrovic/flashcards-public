...
class FlashcardsFilterOptions extends StatelessWidget {
  const FlashcardsFilterOptions({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocSelector<
      FlashcardsSearcherBloc,
      FlashcardsSearcherState,
  ...
  Widget build(BuildContext context) {
    ...
    void onChanged(value) {
      context.read<FlashcardsSearcherBloc>().add(
        FlashcardsSearcherTagToggled(tag: tagCount.key),
      );
    }
