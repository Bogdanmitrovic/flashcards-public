...
@JsonKey(includeToJson: false) String? get id; String get name;
...
@useResult
$Res call({
@JsonKey(includeToJson: false) String? id, String name
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String? id,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TagDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String? id,  String name)  $default,) {final _that = this;
switch (_that) {
case _TagDto():
return $default(_that.id,_that.name);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeToJson: false)  String? id,  String name)?  $default,) {final _that = this;
switch (_that) {
case _TagDto() when $default != null:
return $default(_that.id,_that.name);case _:
  return null;
...
class _TagDto implements TagDto {
  const _TagDto({@JsonKey(includeToJson: false) required this.id, required this.name});
